...
class frisbeeOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE " + GAME_TN + "("+GAME_ID+" TIMESTAMP PRIMARY KEY, "+ GAME_TIME_ENDED +" TIMESTAMP, "+ OPPONENT_NAME +" TEXT, "+ GAME_OUR_SCORE +" INTEGER, " +GAME_THEIR_SCORE+" INTEGER, "+TOURNAMENT_ID+" TEXT)");
